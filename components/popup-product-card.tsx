...
export function ProductCard({
  ...
  return (
    <Card className="w-[90%] max-w-sm mx-auto bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden pb-[30px] mb-[20px] relative">
      <h1 className="absolute top-2 left-2 rounded-full py-1.5 bg-black/50 text-white px-2  z-[1000] text-[12px]">
        #{position + 1}
      </h1>
      {/* Navigation arrows */}
      ...
      <div className="px-6 py-[0px]">
        ...
        {/* Product Name */}
        <p className="text-[11px] text-gray-600 text-left leading-relaxed ">
          {name}
        </p>
        ...
        >
          ...
          <Button
            className="flex-1 bg-[#c41230] text-white h-8 text-[12px] btnMultimediaAsesorAi"
            onClick={() => handleMultimediaClick(product)}
          >
            Multimedia
