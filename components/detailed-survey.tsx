...
export function DetailedSurvey({ onClose, onComplete }: DetailedSurveyProps) {
  ...
  const reasonOptions = ["Buena comunicación", "Problema resuelto", "Tono amable", "Guía útil", "Atención rápida"]
    ...
    <div className="absolute inset-0 bg-white/95 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-gray-200 p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="font-semibold text-gray-900">Encuesta rápida</h3>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h4 className="font-medium text-gray-900 text-sm mb-2">
              ¿Por qué te sentiste así? <span className="text-gray-500 font-normal">(opcional)</span>
            </h4>
            <p className="text-xs text-gray-600 mb-3">Selecciona todas las opciones que correspondan:</p>
          ...
          <div>
            <h4 className="font-medium text-gray-900 text-sm mb-2">
              ¿Quieres compartir algún otro detalle adicional?{" "}
