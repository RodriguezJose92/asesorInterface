...
export function DetailedSurvey({ onClose, onComplete }: DetailedSurveyProps) {
  ...
  const currentLang =
    languageCurrent === "es" || languageCurrent === "en"
      ? languageCurrent
      : "en";

  const reasonOptions = [
    dataLanguage.realSurvey[currentLang][5],
    dataLanguage.realSurvey[currentLang][6],
    dataLanguage.realSurvey[currentLang][7],
    dataLanguage.realSurvey[currentLang][8],
    dataLanguage.realSurvey[currentLang][9],
  ].filter(Boolean);
      ...
      <Card className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-gray-200 p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="font-semibold text-gray-900">
            {dataLanguage.realSurvey[currentLang][0]}
          </h3>
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="space-y-6">
          ...
          <div>
            <h4 className="font-medium text-gray-900 text-sm mb-4 leading-relaxed">
              {dataLanguage.realSurvey[currentLang][1]}
            </h4>
            <div className="flex gap-3 justify-center">
              <Button
                ...
                className={`w-16 h-16 p-0 ${
                  satisfaction === "yes" ? "bg-[#c41230] " : "border-[#c41230]"
                }`}
              >
              ...
              <Button
                ...
                className={`w-16 h-16 p-0 ${
                  satisfaction === "no" ? "bg-[#c41230] " : "border-[#c41230]"
                }`}
              >
          ...
          <div>
            <h4 className="font-medium text-gray-900 text-sm mb-2">
              {dataLanguage.realSurvey[currentLang][2]}
              <span className="text-gray-500 font-normal">
                {dataLanguage.realSurvey[currentLang][3]}
              </span>
            </h4>
            <p className="text-xs text-gray-600 mb-3">
              {dataLanguage.realSurvey[currentLang][4]}
            </p>
          ...
          <div>
            ...
            <div className="relative">
              <Textarea
                placeholder={dataLanguage.realSurvey[currentLang][7]}
                value={comments}
          ...
          <Button
            ...
            className="w-full bg-[#c41230] text-white h-11 mt-6"
          >
            {dataLanguage.realSurvey[currentLang][8]}
          </Button>
        </div>
